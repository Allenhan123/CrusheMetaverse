...
namespace QFrame
{
    ...
    public static class Path
    {
        ...
        {
            get { return Application.persistentDataPath + "/unity"; }
        }
        ...
        {
            get { return Application.persistentDataPath + "/unity/temp"; }
        }
        ...
        public static string GetResourceNameWithSuffix(string resourceName)
        {
            ...
            {
                throw new SystemException("Resource name is invalid.");
            }
        ...
        public static bool RemoveEmptyDirectory(string directoryName)
        {
            ...
            {
                throw new SystemException("Directory name is invalid.");
            }
        ...
        public static string GetFileName(string filePath, bool bExtension = true)
        {
